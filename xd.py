...
file_server = requests.get("https://raw.githubusercontent.com/Ahmed-XD/FILE/main/file_on.txt").text
random_server = requests.get("https://raw.githubusercontent.com/Ahmed-XD/FILE/main/random-on.txt").text
def intro():
